(function (global, factory) {
	...
	(factory((global['angular2-qrscanner'] = {}),global.ng.core,global.ng.common));
    ...
    function FinderPatternFinder(width, height) {
        ...
        this.orderBestPatterns = function (patterns) {
            ...
            function distance(pattern1, pattern2) {
                var /** @type {?} */ xDiff = pattern1.X - pattern2.X;
                var /** @type {?} */ yDiff = pattern1.Y - pattern2.Y;
...
var PerspectiveTransform = /** @class */ (function () {
    ...
    PerspectiveTransform.quadrilateralToSquare = function (x0, y0, x1, y1, x2, y2, x3, y3) {
        ...
        var /** @type {?} */ t = this.squareToQuadrilateral(x0, y0, x1, y1, x2, y2, x3, y3);
    ...
    Object.defineProperty(QRCodeDataBlockReader.prototype, "DataByte", {
        ...
        get: function () {
            ...
            do {
                ...
                var /** @type {?} */ dataLength = this.getDataLength(mode);
                if (dataLength < 1)
...
var QRCode = /** @class */ (function () {
    ...
    QRCode.prototype.getPixel = function (x, y) {
        ...
        var /** @type {?} */ point = (x * 4) + (y * this.width * 4);
        var /** @type {?} */ p = (this.imagedata.data[point] * 33 + this.imagedata.data[point + 1] * 34 + this.imagedata.data[point + 2] * 33) / 100;
        return p;
    };
    /**
     * @param {?} image
...
var QrScannerComponent = /** @class */ (function () {
    ...
    function QrScannerComponent(renderer, element) {
        ...
        this.updateTime = 500;
        this.onRead = new core.EventEmitter();
        this.qrCode = null;
    ...
    QrScannerComponent.prototype.isCanvasSupported = function () {
        var /** @type {?} */ canvas = this.renderer.createElement('canvas');
    ...
    Object.defineProperty(QrScannerComponent.prototype, "findMediaDevices", {
        ...
        get: function () {
            var _this = this;
            var /** @type {?} */ videoDevice = function (dvc) { return dvc.kind === 'videoinput' && dvc.label.search(/back/i) > -1; };
            return new Promise(function (resolve, reject) {
                if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices) {
                    try {
                        navigator.mediaDevices.enumerateDevices()
                            .then(function (devices) {
                            var /** @type {?} */ device = devices.find(function (_device) { return videoDevice(_device); });
                            if (device) {
